  ...
  <div class="row">
    ...
    <div class="col-sm-4">
      <div class="card" style="width:100%;margin:20px 0 24px 0;border: 2px solid black; background:rgba(255,255,255,0.5); padding: 3px; text-align:center">
	      <h2 class="card-title">Luke's Projects</h2>
	      <h5 class="card-body"><a href="https://github.com/lyaegel88">Click here to find me on GitHub!</a></h5>
	      <div><img src="${pageContext.request.contextPath}/resources/images/github.png" alt="github" height=125 width=350></div>
      </div>
